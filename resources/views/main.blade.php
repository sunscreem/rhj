...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        <title>RHJ Contracts :: 15 Years Of Multi-Trade Experience :: Edinburgh, East & Midlothian, Fife & Surrounding Areas</title>
    ...
    <!-- Header (navigation menu, and logo) -->
        <nav class="navbar navbar-default header-navbar" role="navigation" id="home">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#">
                                <!-- Logo Image -->
                                <img src="img/logo.png" alt="RHJ Contracts">
                            </a>
                        </div>
                    </div>
        ...
        @include('partials.customer_testimonials')
    ...
    <!-- From Blog -->
      ...
      <!-- Section General Title -->
        ...
        <!-- Google Tag Manager -->
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-PV39M4"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-PV39M4');</script>
